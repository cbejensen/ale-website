...
$error = 0;
$q	=	"create table `".$mysql_table_prefix."sites`(
...
$q	=	"create table `".$mysql_table_prefix."links` (
...
// 	$error += mysql_errno();
// }
$q	=	"create table `".$mysql_table_prefix."keywords`	(
...
for ($i=0;$i<=15; $i++) {
	$char = dechex($i);
	$q	=	"create table `".$mysql_table_prefix."link_keyword$char` (
...
$q	=	"create table `".$mysql_table_prefix."categories` (
...
$q	=	"create table `".$mysql_table_prefix."site_category` (
		site_id integer,
		category_id integer
		)";
db_query($q, $success);
...
$q	=	"create table `".$mysql_table_prefix."temp` (
		link varchar(255),
		level integer,
		id varchar (32)
		)";
...
$q	=	"create table `".$mysql_table_prefix."pending` (
		site_id integer,
		temp_id varchar(32),
		level integer,
		count integer,
...
$q	=	"create table `".$mysql_table_prefix."query_log` (
		query varchar(255),
		time timestamp(6),
		elapsed float(2),
		results int, 
...
$q	=	"create table `".$mysql_table_prefix."domains` (
